...
public interface StakeholderApiDelegate {
     ...
     */
    default ResponseEntity<Void> deleteStakeholderById(List<Integer> stakeholderId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     */
    default ResponseEntity<Void> loadStakeholderById(List<Integer> stakeholderId) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
